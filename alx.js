...
var _user$project$Project$decodeList = _elm_lang$core$Json_Decode$list(_user$project$Project$decodeProject);
...
var _user$project$Main$sourceUrl = 'http://gsam.ga/projects/api/projects';
...
var _user$project$Main$fetchProjects = function (msg) {
	return A3(
		...
		msg,
		A2(_evancz$elm_http$Http$get, _user$project$Project$decodeList, _user$project$Main$sourceUrl));
};
